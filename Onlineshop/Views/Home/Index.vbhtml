                ...
                <div class="col-md d-none d-lg-block flex-grow-1">
                    <aside class="special-home-right">
                        ...
                        <div class="card-banner border-bottom">
                            ...
                            <img src="~/content/images/items/1.jpg" height="80" class="img-bg">
                        </div>
                        ...
                        <div class="card-banner border-bottom">
                            ...
                            <img src="~/content/images/items/2.jpg" height="80" class="img-bg">
                        </div>
                        ...
                        <div class="card-banner border-bottom">
                            ...
                            <img src="~/content/images/items/6.jpg" height="80" class="img-bg">
                        </div>
    ...
    <div class="card card-deal">
        ...
        <div class="row no-gutters items-wrap">
            <div class="col-md col-6">
                <figure class="card-product-grid card-sm">
                    <a href="#" class="img-wrap">
                        <img src="~/content/images/items/3.jpg">
                    </a>
            ...
            <div class="col-md col-6">
                <figure class="card-product-grid card-sm">
                    <a href="#" class="img-wrap">
                        <img src="~/content/images/items/4.jpg">
                    </a>
                    <div class="text-wrap p-3">
            ...
            <div class="col-md col-6">
                <figure class="card-product-grid card-sm">
                    <a href="#" class="img-wrap">
                        <img src="~/content/images/items/5.jpg">
                    </a>
                    <div class="text-wrap p-3">
            ...
            <div class="col-md col-6">
                <figure class="card-product-grid card-sm">
                    <a href="#" class="img-wrap">
                        <img src="~/content/images/items/6.jpg">
                    </a>
                    <div class="text-wrap p-3">
            ...
            <div class="col-md col-6">
                <figure class="card-product-grid card-sm">
                    <a href="#" class="img-wrap">
                        <img src="~/content/images/items/7.jpg">
                    </a>
                    <div class="text-wrap p-3">
                ...
                <ul class="row no-gutters bordered-cols">
                    <li class="col-6 col-lg-3 col-md-4">
                        <a href="#" class="item">
                            <div class="card-body">
                                ...
                                <img class="img-sm float-right" src="~/content/images/items/1.jpg">
                    ...
                    <li class="col-6 col-lg-3 col-md-4">
                        <a href="#" class="item">
                            <div class="card-body">
                                ...
                                <img class="img-sm float-right" src="~/content/images/items/2.jpg">
                    ...
                    <li class="col-6 col-lg-3 col-md-4">
                        <a href="#" class="item">
                            <div class="card-body">
                                ...
                                <img class="img-sm float-right" src="~/content/images/items/3.jpg">
                    ...
                    <li class="col-6 col-lg-3 col-md-4">
                        <a href="#" class="item">
                            <div class="card-body">
                                ...
                                <img class="img-sm float-right" src="~/content/images/items/4.jpg">
                    ...
                    <li class="col-6 col-lg-3 col-md-4">
                        <a href="#" class="item">
                            <div class="card-body">
                                <h6 class="title">Home and kitchen electronic  stuff collection  </h6>
                                <img class="img-sm float-right" src="~/content/images/items/5.jpg">
                    ...
                    <li class="col-6 col-lg-3 col-md-4">
                        <a href="#" class="item">
                            <div class="card-body">
                                <h6 class="title">Home and kitchen electronic  stuff collection  </h6>
                                <img class="img-sm float-right" src="~/content/images/items/6.jpg">
                                <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
                            </div>
                        </a>
                    </li>
                    <li class="col-6 col-lg-3 col-md-4">
                        <a href="#" class="item">
                            <div class="card-body">
                                ...
                                <img class="img-sm float-right" src="~/content/images/items/7.jpg">
                ...
                <ul class="row no-gutters bordered-cols">
                    ...
                    <li class="col-6 col-lg-3 col-md-4">
                        <a href="#" class="item">
                            <div class="card-body">
                                ...
                                <img class="img-sm float-right" src="~/content/images/items/8.jpg">
                                <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Hong Kong, China</p>
                            </div>
                        </a>
                    </li>
                    <li class="col-6 col-lg-3 col-md-4">
                        <a href="#" class="item">
                            <div class="card-body">
                                <h6 class="title">Home and kitchen electronic  stuff collection  </h6>
                                <img class="img-sm float-right" src="~/content/images/items/9.jpg">
                                <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Tashkent, Uzb</p>
                            </div>
                        </a>
                    </li>
                    <li class="col-6 col-lg-3 col-md-4">
                        <a href="#" class="item">
                            <div class="card-body">
                                ...
                                <img class="img-sm float-right" src="~/content/images/items/10.jpg">
                                <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
                            </div>
                        </a>
                    </li>
                    <li class="col-6 col-lg-3 col-md-4">
                        <a href="#" class="item">
                            <div class="card-body">
                                <h6 class="title">Home and kitchen electronic  stuff collection  </h6>
                                <img class="img-sm float-right" src="~/content/images/items/11.jpg">
                                <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
                            </div>
                        </a>
                    </li>
                    <li class="col-6 col-lg-3 col-md-4">
                        <a href="#" class="item">
                            <div class="card-body">
                                <h6 class="title">Home and kitchen electronic  stuff collection  </h6>
                                <img class="img-sm float-right" src="~/content/images/items/12.jpg">
                                <p class="text-muted"><i class="fa fa-map-marker-alt"></i> Guanjou, China</p>
                            </div>
                        </a>
                    </li>
    ...
    <div class="row row-sm">
        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
            <div href="#" class="card card-sm card-product-grid">
                <a href="#" class="img-wrap"> <img src="~/content/images/items/1.jpg"> </a>
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
            <div href="#" class="card card-sm card-product-grid">
                <a href="#" class="img-wrap"> <img src="~/content/images/items/2.jpg"> </a>
                <figcaption class="info-wrap">
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
            <div href="#" class="card card-sm card-product-grid">
                <a href="#" class="img-wrap"> <img src="~/content/images/items/3.jpg"> </a>
                <figcaption class="info-wrap">
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
            <div href="#" class="card card-sm card-product-grid">
                <a href="#" class="img-wrap"> <img src="~/content/images/items/4.jpg"> </a>
                <figcaption class="info-wrap">
                    <a href="#" class="title">Just another product name</a>
                    <div class="price mt-1">$179.00</div> <!-- price-wrap.// -->
                </figcaption>
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
            <div href="#" class="card card-sm card-product-grid">
                <a href="#" class="img-wrap"> <img src="~/content/images/items/5.jpg"> </a>
                <figcaption class="info-wrap">
                    <a href="#" class="title">Just another product name</a>
                    <div class="price mt-1">$179.00</div> <!-- price-wrap.// -->
                </figcaption>
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
            <div href="#" class="card card-sm card-product-grid">
                <a href="#" class="img-wrap"> <img src="~/content/images/items/6.jpg"> </a>
                <figcaption class="info-wrap">
                    <a href="#" class="title">Some item name here</a>
                    <div class="price mt-1">$280.00</div> <!-- price-wrap.// -->
                </figcaption>
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
            <div href="#" class="card card-sm card-product-grid">
                <a href="#" class="img-wrap"> <img src="~/content/images/items/7.jpg"> </a>
                <figcaption class="info-wrap">
                    <a href="#" class="title">Great product name here</a>
                    <div class="price mt-1">$56.00</div> <!-- price-wrap.// -->
                </figcaption>
        ...
        <div class="col-xl-2 col-lg-3 col-md-4 col-6">
            <div href="#" class="card card-sm card-product-grid">
                <a href="#" class="img-wrap"> <img src="~/content/images/items/9.jpg"> </a>
                <figcaption class="info-wrap">
                    <a href="#" class="title">Just another product name</a>
                    <div class="price mt-1">$179.00</div> <!-- price-wrap.// -->
                </figcaption>
