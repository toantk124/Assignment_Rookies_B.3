...
<head>
    ...
    <!-- jQuery -->
    <script src="~/Scripts/images/jquery-2.0.0.min.js" type="text/javascript"></script>

    <!-- Bootstrap4 files-->
    <script src="~/Scripts/images/bootstrap.bundle.min.js" type="text/javascript"></script>
    ...
    <!-- custom javascript -->
    <script src="~/Scripts/images/script.js" type="text/javascript"></script>
